...
<c:url value="/descuento/busca"		var="urlBuscaPrecios"/>
<c:url value="/descuento/acepta"	var="urlCreaDescuento"/>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<title>Descuento</title>
		<link rel="stylesheet" href="<c:url value="/resources/css/ventana_descuento.css"/>" type="text/css"></link>
