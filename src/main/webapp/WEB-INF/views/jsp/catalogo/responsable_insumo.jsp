...
<c:url value="/responsable_insumo/catalogo/alta" 		var="urlAlta"/>
<c:url value="/responsable_insumo/catalogo/modifica" 	var="urlModifica"/>
<c:url value="/responsable_insumo/catalogo/elimina" 	var="urlElimina"/>
<html>
    <head>
        <meta http-equiv="Content-type" content="text/html; charset=ISO-8859-1"></meta>
        <title>Responsable de insumo</title>
        <style type="text/css" media="screen">
        
            table#tabla_responsable_insumo {
                overflow-y:scroll;
            }
        
            table#tabla_responsable_insumo tr:hover td  {
                cursor: pointer;
                color:#000;
                background-color: #99CCFF;
            }
            
            #div_responsable_insumo {
                width: 865px;
                margin-left: auto;
                margin-right: auto;
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/responsable_insumo.js"/>"></script>
                ...
                <div id="div_hoja">
                    ...
                    <div id="div_cuerpo">
                        ...
                        <div id="div_contenido">
                            <form action="responsable_insumo" method="post" accept-charset="ISO-8859-1">
                                <div id="div_responsable_insumo">
                                    <div class="titulo">
                                        <img alt="" src="<c:url value="/resources/image/titulo_responsable_insumo.png"/>"></img>
                                    </div>
                                    <div id="div_contenedor_tabla">
                                        <div class="columna_completa">
                                            <div id="div_tabla_responsable_insumo">
                                                <table id="tabla_responsable_insumo">
                                                    <tr>
                                                        <th>Identificador</th>
                                                        <th>Nombre</th>
                                                        <th>Descripci&oacute;n</th>
                                                    </tr>
                                                <c:forEach var="responsableInsumo" items="${listaResponsableInsumo}" varStatus="i">
                                                    <tr class='${i.count%2==0?"l2":"l1"}' 
                                                        onclick="setCampos('${responsableInsumo.idResponsableInsumo}','${responsableInsumo.nombre}','${responsableInsumo.descripcion}');">
                                                        <td>${responsableInsumo.idResponsableInsumo}</td>
                                                        <td>${responsableInsumo.nombre}</td>
                                                        <td>${responsableInsumo.descripcion}</td>
                                                    </tr>
                                                </c:forEach>
                                                </table>
                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="input"
                                                                       name="id_responsable_insumo" value=""
