...
<c:url value="/material_ayuda/catalogo/alta" 		var="urlAlta"/>
<c:url value="/material_ayuda/catalogo/modifica" 	var="urlModifica"/>
<c:url value="/material_ayuda/catalogo/elimina" 	var="urlElimina"/>
<html>
    <head>
        <meta http-equiv="Content-type" content="text/html; charset=ISO-8859-1"></meta>
        <title>Material de ayuda</title>
        <style type="text/css" media="screen">
        
            table#tabla_material_ayuda {
                overflow-y:scroll;
            }
        
            table#tabla_material_ayuda tr:hover td  {
                cursor: pointer;
                color:#000;
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/material_ayuda.js"/>"></script>
                ...
                <div id="div_hoja">
                    ...
                    <div id="div_cuerpo">
                        ...
                        <div id="div_contenido">
                            <form action="material_ayuda" method="post" accept-charset="ISO-8859-1">
                                <div id="div_material_ayuda">
                                    <div class="titulo">
                                        <img alt="" src="<c:url value="/resources/image/titulo_material_ayuda.png"/>"></img>
                                    </div>
                                    <div id="div_contenedor_tabla">
                                        <div class="columna_completa">
                                            <div id="div_tabla_material_ayuda">
                                                ...
                                                <c:forEach var="materialAyuda" items="${listaMaterialAyuda}" varStatus="i">
                                                    <tr class='${i.count%2==0?"l2":"l1"}' 
                                                        onclick="setCampos('${materialAyuda.idMaterialAyuda}','${materialAyuda.nombre}', '${materialAyuda.descripcion}');">
                                                        <td>${materialAyuda.idMaterialAyuda}</td>
                                                        <td>${materialAyuda.nombre}</td>
                                                        <td>${materialAyuda.descripcion}</td>
                                                    </tr>
                                                </c:forEach>
                                                </table>
                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="input"
                                                                       name="id_material_ayuda" value="" tabindex="1"
