...
<c:url value="/proceso_transporte/catalogo/elimina" 	var="urlElimina"/>
<html>
    <head>
        <meta http-equiv="Content-type" content="text/html; charset=ISO-8859-1"></meta>
        <title>Procesos de transporte</title>
        <style type="text/css" media="screen">
        
            table#tabla_proceso_transporte {
                overflow-y:scroll;
            }
        
            table#tabla_proceso_transporte tr:hover td  {
                cursor: pointer;
                color:#000;
                background-color: #99CCFF;
            }
            
            #div_proceso_transporte {
                width: 865px;
                margin-left: auto;
                margin-right: auto;
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/proceso_transporte.js"/>"></script>
                ...
                <div id="div_hoja">
                    ...
                    <div id="div_cuerpo">
                        ...
                        <div id="div_contenido">
                            <form action="proceso_transporte" method="post" accept-charset="ISO-8859-1">
                                <div id="div_proceso_transporte">
                                    <div class="titulo">
                                        <img alt="" src="<c:url value="/resources/image/titulo_proceso_transporte.png"/>"></img>
                                    </div>
                                    <div id="div_contenedor_tabla">
                                        <div class="columna_completa">
                                            <div id="div_tabla_proceso_transporte">
                                                <table id="tabla_proceso_transporte">
                                                    <tr>
                                                        <th height="20">Identificador</th>
                                                        <th height="20">Nombre</th>
                                                        <th height="20">Descripci&oacute;n</th>
                                                        <th height="20">Precio</th>
                                                        <th height="20">Unidad</th>
                                                    </tr>
                                                <c:forEach var="procesoTransporte" items="${listaProcesoTransporte}" varStatus="i">
                                                    <tr class='${i.count%2==0?"l2":"l1"}'
                                                        onclick="setCampos('${procesoTransporte.idProcesoTransporte}','${procesoTransporte.nombreProceso}', '${procesoTransporte.descripcion}', '${procesoTransporte.precio}','${procesoTransporte.tipoPrecio.nombre}' );">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="input"
                                                                       name="id_proceso_transporte" value=""
