...
<c:url value="/proceso_externo/catalogo/alta" 		var="urlAlta"/>
<c:url value="/proceso_externo/catalogo/modifica" 	var="urlModifica"/>
<c:url value="/proceso_externo/catalogo/elimina" 	var="urlElimina"/>
<html>
    <head>
        <meta http-equiv="Content-type" content="text/html; charset=ISO-8859-1"></meta>
        <title>Procesos externos</title>
        <style type="text/css" media="screen">
            
            table#tabla_proceso_externo {
                overflow-y:scroll;
            }
            
            table#tabla_proceso_externo tr:hover td  {
                cursor: pointer;
                color:#000;
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/proceso_externo.js"/>"></script>
                ...
                <div id="div_hoja">
                    ...
                    <div id="div_cuerpo">
                        ...
                        <div id="div_contenido">
                            <form action="proceso_externo" method="post" accept-charset="ISO-8859-1">
                                <div id="div_proceso_externo">
                                    <div class="titulo">
                                        <img alt="" src="<c:url value="/resources/image/titulo_proceso_externo.png"/>"></img>
                                    </div>
                                    <div id="div_contenedor_tabla">
                                        <div class="columna_completa">
                                            <div id="div_tabla_proceso_externo">
                                                <table id="tabla_proceso_externo">
                                                    <tr>
                                                        <th>Identificador</th>
                                                        <th>Proveedor</th>
                                                        <th>Nombre</th>
                                                ...
                                                <c:forEach var="procesoExterno" items="${listaProcesoExterno}" varStatus="i">
                                                    <tr class='${i.count%2==0?"l2":"l1"}'
                                                        onclick="setCampos('${procesoExterno.idProcesoExterno}','${procesoExterno.proveedorExterno.razonSocial}', '${procesoExterno.nombreProceso}','${procesoExterno.observaciones}', '${procesoExterno.precio}','${procesoExterno.tipoPrecio.nombre}' );">
                                                        <td>${procesoExterno.idProcesoExterno}</td>
                                                        <td>${procesoExterno.proveedorExterno.razonSocial}</td>
                                                        <td>${procesoExterno.nombreProceso}</td>
                                                        <td>${procesoExterno.observaciones}</td>
                                                        <td>${procesoExterno.precio}</td>
                                                        <td>${procesoExterno.tipoPrecio.nombre}</td>
                                                    </tr>
                                                </c:forEach>
                                                </table>
                                            </div>
                                    ...
                                    <div class="titulo">
                                        <img alt="" src="resources/image/titulo_detalle.png"></img>
                                    </div>
                                    <div class="linea">
                                        <div class="casilla">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="input"
                                                                       name="id_proceso_externo" value="" tabindex="1"
                                                ...
                                                <div class="mitad_columna_derecha">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="id_proveedor_externo" tabindex="2" onchange="">
                                                                    <c:forEach var="proveedorExterno" items="${listaProveedorExterno}">
                                                                        <option value="${proveedorExterno.value}">${proveedorExterno.text}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </td>
                                                        </tr>
