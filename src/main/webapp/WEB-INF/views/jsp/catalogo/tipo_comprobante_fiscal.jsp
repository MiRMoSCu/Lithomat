...
<c:url value="/tipo_comprobante_fiscal/catalogo/elimina" 	var="urlElimina"/>
<html>
    <head>
        <meta http-equiv="Content-type" content="text/html; charset=ISO-8859-1"></meta>
        <title>Tipo de Comprobante Fiscal</title>
        <style type="text/css" media="screen">
        
            table#tabla_tipo_comprobante_fiscal {
                overflow-y:scroll;
            }
            
            table#tabla_tipo_comprobante_fiscal tr:hover td  {
                cursor: pointer;
                color:#000;
                background-color: #99CCFF;
            }
            
            #div_tipo_comprobante_fiscal {
                width: 865px;
                margin-left: auto;
                margin-right: auto;
            ...
            #div_tabla_tipo_comprobante_fiscal {
                width: 100%;
                height: 100%;
                overflow-x: scroll;
            }
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/tipo_comprobante_fiscal.js"/>"></script>
                ...
                <div id="div_hoja">
                    ...
                    <div id="div_cuerpo">
                        ...
                        <div id="div_contenido">
                            <form action="tipo_comprobante_fiscal" method="post" accept-charset="ISO-8859-1">
                                <div id="div_tipo_comprobante_fiscal">
                                    <div class="titulo">
                                        <img alt="" src="<c:url value="/resources/image/titulo_tipo_comprobante_fiscal.png"/>"></img>
                                    </div>
                                    <div id="div_contenedor_tabla">
                                        <div class="columna_completa">
                                            <div id="div_tabla_tipo_comprobante_fiscal">
                                                <table id="tabla_tipo_comprobante_fiscal">
                                                    <tr>
                                                        <th>Identificador</th>
                                                        <th>Nombre</th>
                                                ...
                                                <c:forEach var="tipoComprobanteFiscal" items="${listaTipoComprobanteFiscal}" varStatus="i">
                                                    <tr class='${i.count%2==0?"l2":"l1"}'
                                                        onclick="setCampos('${tipoComprobanteFiscal.idTipoComprobanteFiscal}', '${tipoComprobanteFiscal.nombre}', '${tipoComprobanteFiscal.descripcion}', '${tipoComprobanteFiscal.precio}', '${tipoComprobanteFiscal.tipoPrecio.nombre}' );">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="input"
                                                                       name="id_tipo_comprobante_fiscal" value=""
