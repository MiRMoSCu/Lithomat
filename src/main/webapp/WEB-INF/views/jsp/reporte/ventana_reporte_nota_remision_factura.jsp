...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="/resources/css/ventana_reporte_nota_remision_factura.css"/>" type="text/css"></link>
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/ventana_reporte_nota_remision_factura.js"/>"></script>
