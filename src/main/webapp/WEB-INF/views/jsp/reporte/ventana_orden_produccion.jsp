...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="/resources/css/reporte_ventana_orden_produccion.css"/>" type="text/css"></link>
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/reporte_ventana_orden_produccion.js"/>"></script>
