...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="/resources/css/reporte_ventana_cotizacion.css"/>" type="text/css"></link>
        ...
        <script type="text/javascript" src="<c:url value="/resources/js/reporte_ventana_cotizacion.js"/>"></script>
