...
CREATE TABLE IF NOT EXISTS `lithomat_artiffex`.`tipo_trabajo_detalle` (
  ...
  `alto_final` FLOAT NULL,
  `ancho_final` FLOAT NULL,
  ...
  `alto_corte_inicial` FLOAT NULL,
  `ancho_corte_inicial` FLOAT NULL,
...
CREATE TABLE IF NOT EXISTS `lithomat_artiffex`.`fecha_prensista_maquina` (
  ...
  `frente_kilos_tinta_cyan` FLOAT NULL,
  `frente_kilos_tinta_magenta` FLOAT NULL,
  `frente_kilos_tinta_yellow` FLOAT NULL,
  `frente_kilos_tinta_black` FLOAT NULL,
  `vuelta_kilos_tinta_cyan` FLOAT NULL,
  `vuelta_kilos_tinta_magenta` FLOAT NULL,
  `vuelta_kilos_tinta_yellow` FLOAT NULL,
  `vuelta_kilos_tinta_black` FLOAT NULL,
  `usuario` VARCHAR(45) NULL,
  `fecha_generacion` TIMESTAMP NULL,
  `activo` TINYINT(1) NULL,
...
CREATE TABLE IF NOT EXISTS `lithomat_artiffex`.`calificacion_trabajo_detalle` (
  ...
  `costos_extra_coste_total` DECIMAL(12,2) NULL,
  `activo` TINYINT(1) NULL,
