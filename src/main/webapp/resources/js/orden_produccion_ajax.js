        ...
        case 2:
            if( correcto
            		&& ( numero_paginas_publicacion == ""
            			|| isNaN( numero_paginas_publicacion )
            			|| parseInt( numero_paginas_publicacion ) <= 0 
