...
/* funciones */
function setCampos(id_perfil, nombre, descripcion) {
    document.forms[0].id_perfil.value   	= id_perfil;
    document.forms[0].nombre.value 			= nombre;
    document.forms[0].descripcion.value     = descripcion;
}

function crear() {
    if (document.forms[0].nombre.value == "" || document.forms[0].descripcion.value == "")
...
function limpia() {
    document.forms[0].id_perfil.value   	= "";
