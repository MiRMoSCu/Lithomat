...
/* funciones */
function setCampos(id_proveedor_externo, razon_social, calle, num_exterior, num_interior, colonia, delegacion, estado, codigo_postal, telefono, observaciones) {
    document.forms[0].id_proveedor_externo.value    = id_proveedor_externo;
...
function limpia() {
    document.forms[0].id_proveedor_externo.value    = "";
