...
/* funciones */
function setCampos(id_proceso_transporte, nombre_proceso, descripcion, precio, nombre_precio) {
    ...
    document.forms[0].id_proceso_transporte.value   = id_proceso_transporte;
...
function limpia() {
    document.forms[0].id_proceso_transporte.value   = "";
