...
/* funciones */
function setCampos( id_tipo_comprobante_fiscal, nombre, descripcion, precio, nombre_precio ) {
    ...
    document.forms[0].id_tipo_comprobante_fiscal.value  = id_tipo_comprobante_fiscal;
...
function limpia() {
    document.forms[0].id_tipo_comprobante_fiscal.value  = "";
