...
function setCamposTipoPapelExtendido( id_tipo_papel_extendido, nombre_proveedor, nombre_papel, gramaje, kilogramos, alto, ancho, precio ) {
	document.tipo_trabajo_detalle.descripcion_completa.value = nombre_papel + " " + gramaje + " gr. " + alto + " x " + ancho + " cm. (" + kilogramos + " kg.) ($" + precio + ") [" + nombre_proveedor + "]";
...
function limpia() {
	...
	// limpia tabla
	document.getElementById("tabla_tipo_papel_extendido").innerHTML = "<table><tr><th>Id.</th><th>Proveedor</th><th>Nombre</th><th>Gramaje</th><th>Kilogramos</th><th>Alto</th><th>Ancho</th><th>Precio</th><th>Unidad</th></tr><tr class=\"l1\"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table>";
