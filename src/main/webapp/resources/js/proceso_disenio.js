...
/* funciones */
function setCampos(id_proceso_disenio, nombre_proceso, descripcion, precio, nombre_tipo_precio) {
    ...
    for (i = 0;i < select.length;i++) {
        ...
        if (select.options[i].innerText == nombre_tipo_precio) {
            index_precio = i;
            break;
        }
    }
    
    document.forms[0].id_proceso_disenio.value      = id_proceso_disenio;
...
function limpia() {
    document.forms[0].id_proceso_disenio.value      = "";
